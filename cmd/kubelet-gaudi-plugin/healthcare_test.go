...
func TestGaudiUpdateHealth(t *testing.T) {
	...
	for _, testcase := range tests {
		...
		testDevices := device.DevicesInfo{
			"0000-b3-00-0-0x1020": {Model: "0x1020", PCIAddress: "0000:b3:00.0", DeviceIdx: 0, UID: "0000-b3-00-0-0x1020", Serial: "000001", PCIRoot: "pci0000:01"},
			"0000-af-00-0-0x1020": {Model: "0x1020", PCIAddress: "0000:af:00.0", DeviceIdx: 1, UID: "0000-af-00-0-0x1020", Serial: "000002", PCIRoot: "pci0000:01"},
		}
...
func TestTimedHLMLEventCheckErrors(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			addUnexpectedDevices: device.DevicesInfo{
				"0000-d5-00-0-0x1020": {Model: "0x1020", PCIAddress: "0000:d5:00.0", DeviceIdx: 2, UID: "0000-d5-00-0-0x1020", Serial: "000003", PCIRoot: "02"},
			},
		},
	}
	// One test setup for all cases.
