	...
	testcases := []testCase{
		{
			...
			request: []*resourcev1.ResourceClaim{
				testhelpers.NewClaim("default", "claim1", "uid1", "request1", "gaudi.intel.com", "node1", "gaudi.intel.com", []string{"0000-00-02-0-0x1020"}, false),
			},
			expectedResponse: map[types.UID]kubeletplugin.PrepareResult{
				"uid1": {
		...
		},
		{
			...
			request: []*resourcev1.ResourceClaim{
				testhelpers.NewClaim("namespace2", "claim2", "uid2", "request2", "gaudi.intel.com", "node1", "gaudi.intel.com", []string{"0000-00-02-0-0x1020"}, false),
			},
			expectedResponse: map[types.UID]kubeletplugin.PrepareResult{
				"uid2": {
					Devices: []kubeletplugin.Device{
		...
		},
		{
			...
			request: []*resourcev1.ResourceClaim{
				testhelpers.NewClaim("namespace3", "claim3", "uid3", "request3", "gaudi.intel.com", "node1", "gaudi.intel.com", []string{"0000-00-05-0-0x1020"}, false),
			},
			expectedResponse: map[types.UID]kubeletplugin.PrepareResult{
		...
		},
		{
			...
			request: []*resourcev1.ResourceClaim{
				testhelpers.NewClaim("default", "claim5", "uid5", "request5", "gaudi.intel.com", "node1", "gaudi.intel.com", []string{"0000-00-02-0-0x1020"}, false),
			},
			expectedResponse: map[types.UID]kubeletplugin.PrepareResult{
