...
type GaudiClaimParametersSpec = intelcrd.GaudiClaimParametersSpec

// Main GaudiClaimParameters object for storing resource request specification.
type GaudiClaimParameters = intelcrd.GaudiClaimParameters

// List of GaudiClaimParameters.
type GaudiClaimParametersList = intelcrd.GaudiClaimParametersList
