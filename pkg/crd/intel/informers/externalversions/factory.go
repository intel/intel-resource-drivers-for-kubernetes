...
import (
	...
	intel "github.com/intel/intel-resource-drivers-for-kubernetes/pkg/crd/intel/informers/externalversions/intel"
...
func (f *sharedInformerFactory) Gpu() intel.Interface {
	return intel.New(f, f.namespace, f.tweakListOptions)
}
