...
require (
	...
	k8s.io/api v0.36.4
	k8s.io/apiextensions-apiserver v0.36.4 // indirect; to fix k8s.io/kubernetes/test/e2e/framework/pod dependency
	k8s.io/apimachinery v0.36.4
	k8s.io/client-go v0.36.4
	k8s.io/code-generator v0.36.4
	k8s.io/component-base v0.36.4
	k8s.io/controller-manager v0.36.4 // indirect; temporary
	k8s.io/dynamic-resource-allocation v0.36.4
	k8s.io/klog/v2 v2.140.0
	k8s.io/kubectl v0.36.4 // indirect; temporary
